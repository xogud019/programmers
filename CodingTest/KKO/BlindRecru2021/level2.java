package CodingTest.KKO.BlindRecru2021;
...
public class level2 {
    ...
    public String[] solution(String[] orders, int[] course) {
        ...
        for(int i:course){
            ...
            for(String s:menu.keySet()){
                if(s.length()!=i || menu.get(s) < 2) continue;
    ...
    public void combi(List<String> list, String str, int idx, int max){
        if(list.size()==max){
        ...
        for(int i=idx; i<str.length(); i++){
            ...
            combi(list, str, i+1, max);
            list.remove(list.size()-1);
        }
    }
    
    public void copy(List<String> l1, List<String> l2){
